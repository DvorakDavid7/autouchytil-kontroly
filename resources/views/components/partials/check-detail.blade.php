    ...
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
            ...
            <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                Při kontrole se neopírám jen o tabulky a checklisty — využívám svých bohatých zkušeností z praxe a
                kombinuji
        ...
        <div>
            <div>
                <img src="{{ asset('images/check_detail.png') }}" alt="detailní ilustrace kontroly vozidla"
