<section class="bg-white py-20" id="reservation">
{{-- <section class="bg-gray-50 py-20" id="reservation"> --}}
    <div class=" bg-white px-6 max-w-3xl mx-auto">
        ...
        <p class="text-center text-gray-700 mb-10 text-lg max-w-xl mx-auto">
            ...
            nebo nám rovnou zavolejte na: <br>
            <a href="tel:+420774034180" class="text-[#e32014] font-semibold hover:underline">(+420) 774 034 180</a>.
        </p>
